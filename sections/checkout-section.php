                ...
                <div class="col-lg-6 col-md-12 col-sm-12 column">
                    <div class="product-information">
                        <div class="single-item clearfix">
                            <figure class="product-image"><img src="images/resource/shop/prod-thumb-4.jpg" alt=""></figure>
                            <h5>Hand Shovel</h5>
                        ...
                        <div class="btn-box">
                            <button type="button" class="theme-btn btn-style-four"><span class="btn-title">Continue <i class="arrow flaticon-play-button-1"></i></span></button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-details">
                            ...
                            <div class="details-inner default-form">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <button type="submit" class="theme-btn btn-style-four"><span class="btn-title">Make Payment <i class="arrow flaticon-play-button-1"></i></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
