...
function mthan_section_cta_html_2($section_data) {
    ...
    $btn2_text = !empty($section_data['cta2_btn2_text']) ? $section_data['cta2_btn2_text'] : 'Residential';
    $btn2_link = !empty($section_data['cta2_btn2_link']) ? $section_data['cta2_btn2_link'] : '#';
?>
