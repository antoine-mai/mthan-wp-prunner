				...
				<div class="auto-container">
					<div class="content-box">
                        <div class="content clearfix">
                            <div class="inner">
                                <div class="subtitle"> High Quality & Affordable Price</div>
                                ...
                                <div class="link-box clearfix">
                                    ...
                                    <a href="contact.html" class="theme-btn btn-style-three"><span class="btn-title">Contact Us <i class="arrow flaticon-play-button-1"></i></span></a>
                                </div>
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box right-aligned">
                        <div class="content clearfix">
                            <div class="inner">
                                <div class="subtitle">Adding Perfection to Your Lawn</div>
                                <h1>Lawn Stylist</h1>
                                <div class="link-box clearfix">
                                    <a href="about.html" class="theme-btn btn-style-one"><span class="btn-title">Read More <i class="arrow flaticon-play-button-1"></i></span></a>
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <div class="content clearfix">
                            <div class="inner">
                                <div class="subtitle">Solutions for Your Green Edge</div>
                                <h1>Build and Care</h1>
                                <div class="link-box clearfix">
                                    <a href="about.html" class="theme-btn btn-style-one"><span class="btn-title">Read More <i class="arrow flaticon-play-button-1"></i></span></a>
                                    <a href="services.html" class="theme-btn btn-style-three"><span class="btn-title">Services <i class="arrow flaticon-play-button-1"></i></span></a>
                                </div>
