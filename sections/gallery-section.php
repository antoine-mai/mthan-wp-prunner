            ...
            <div class="mixitup-gallery">
                ...
                <div class="gallery-filters centered clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        <li class="active filter" data-role="button" data-filter="all">All<span class="count">15</span></li>
                        <li class="filter" data-role="button" data-filter=".garden">Garden<span class="count">5</span></li>
                        <li class="filter" data-role="button" data-filter=".landscape">landscape<span class="count">3</span></li>
                        <li class="filter" data-role="button" data-filter=".lawncare">Lawn Care<span class="count">4</span></li>
                        <li class="filter" data-role="button" data-filter=".removal">Removal<span class="count">3</span></li>
                        <li class="filter" data-role="button" data-filter=".pathways">Pathways<span class="count">5</span></li>
                    </ul>
                </div>
                <div class="filter-list row">
                    ...
                    <div class="gallery-item mix all garden col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <img src="images/gallery/8.jpg" alt="" title="">
                            </div>
                            <div class="hover-box">
                                <div class="hvr-content">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all pathways col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all garden pathways col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all garden lawncare pathways col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all garden lawncare landscape removal col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                            ...
                            <div class="hover-box">
                                <div class="hvr-content">
                                    <div class="cat"><a href="#">Landscape</a></div>
                                    <h5><a href="#">Sprinkler Irrigation</a></h5>
                                    <div class="link-box"><a href="#"><span class="icon flaticon-right-arrow-1"></span></a></div>
                                </div>
                            </div>
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all garden lawncare removal pathways col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all landscape pathways col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                    ...
                    <!-- Gallery Item -->
                    <div class="gallery-item mix all landscape removal col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                ...
                <div class="more-box">
                    <a class="theme-btn btn-style-four" href="gallery-grid-2.html"><span class="btn-title">lOAD mORE <i class="arrow flaticon-play-button-1"></i></span></a>
                </div>
            </div>
