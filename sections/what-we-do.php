...
function mthan_section_what_we_do_options()
{
    return array(
            ...
            'default' => array(
                    array(
                    'nav_title' => 'Lawn Care',
                    'nav_icon' => 'flaticon-leaves-1',
                    'bg_image' => array('url' => get_template_directory_uri() . '/assets/images/resource/tab-image-1.jpg'),
                    'box_title' => "Let's Start Your Project",
                    'box_text' => 'Make an appointment & Start your project today.',
                    'box_btn_text' => 'Appointment',
                    'box_btn_link' => '#',
                    'content_subtitle' => 'know About',
                    'content_title' => 'Lawn Care',
                    'content_text' => 'We provide the best lawn care services. Indignation and dislike men who are so beguiled and demoralized.',
                    'bro_thumb' => array('url' => get_template_directory_uri() . '/assets/images/resource/brochure-1.jpg'),
                    ...
                    'nav_icon' => 'flaticon-gardener',
                    'bg_image' => array('url' => get_template_directory_uri() . '/assets/images/resource/tab-image-2.jpg'),
                    'box_title' => "Let's Start Your Project",
                    'box_text' => 'Make an appointment & Start your project today.',
                    'box_btn_text' => 'Appointment',
                    'box_btn_link' => '#',
                    ...
                    'content_text' => 'We provide the best garden care services. Indignation and dislike men who are so beguiled and demoralized.',
                    'bro_thumb' => array('url' => get_template_directory_uri() . '/assets/images/resource/brochure-1.jpg'),
                    'bro_title' => 'Projects & Case Studies',
                    'bro_link_text' => 'Download.pdf',
                    'bro_link_url' => '#',
                    ...
                    'box_btn_link' => '#',
                    'content_subtitle' => 'know About',
                    'content_title' => 'Planting',
                    'content_text' => 'We provide the best planting services. Indignation and dislike men who are so beguiled and demoralized.',
                    'bro_thumb' => array('url' => get_template_directory_uri() . '/assets/images/resource/brochure-1.jpg'),
                    'bro_title' => 'Projects & Case Studies',
                    'bro_link_text' => 'Download.pdf',
                    'bro_link_url' => '#',
